      ...
      <div className="App">
        ...
        <div className="container">
          <Routes>
            ...
            <Route path="/" element={<div className="card mt-4"><div className="card-body"><h2 className="card-title text-primary">Welcome to Octofit Tracker!</h2><p className="card-text">Track your fitness, join teams, compete on the leaderboard, and get personalized workout suggestions.</p></div></div>} />
          </Routes>
        </div>
      </div>
    </Router>
